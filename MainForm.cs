                    ...
                    else
                    {
                        ...
                        if (settingsini.Read("compressor", "SSP") == "7z")
                        {
                            ...
                            if (String.IsNullOrEmpty(settingsini.Read("customcompressoption", "SSP")))
                            {
                                ...
                                {
                                    Compress.StartInfo.Arguments = "a -mx5 -sdel -v5g ..\\Completed\\" + GameName + ".Build." + BuildNo + "." + OS + "." + workarray[2] + ".7z *";
                                }
                    ...
                    else
                    {
                        ...
                        if (settingsini.Read("compressor", "SSP") == "7z")
                        {
                            ...
                            if (String.IsNullOrEmpty(settingsini.Read("customcompressoption", "SSP")))
                            {
                                ...
                                {
                                    Compress.StartInfo.Arguments = "a -mx5 -sdel -v5g ..\\Completed\\Workshop_" + AppID + "_" + WorkshopID + ".7z *";
                                }
